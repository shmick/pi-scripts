These scripts were written and tested on a [Raspberry Pi](http://www.raspberrypi.org/) running [Raspbian](http://www.raspbian.org/). They should run on any linux host without issue.
